...
class PersonalCase(unittest.TestCase):
    ...
    def test_self10(self):
        ...
        user_page.AlertPsw()
        user_page.psw(Pwd())
        user_page.newpsw(GenWord(5))
        user_page.renewpsw(GenWord(5))
        user_page.savepsw()
        user_page.error_psw()
        user_page.screen(self._testMethodDoc)
    ...
    def test_self17(self):
        ...
        user_page.emailverifybtn()
        user_page.emailverifytxt(GenWord(5))
        user_page.emailsave()
        user_page.screen(self._testMethodDoc)
    ...
    def test_self18(self):
        ...
        user_page.emailtxt(RandEmail())
        user_page.emailverifybtn()
        user_page.emailverifytxt(GenWord(6))
        user_page.emailsave()
        user_page.emailtips()
        user_page.screen(self._testMethodDoc)
